...
class Multisafepayvvvgiftcard extends PaymentModule
{
    public function __construct()
    {
        ...
        $this->name = 'multisafepayvvvgiftcard';
        ...
        $this->gateway = 'VVVGIFTCRD';
        $this->displayName = $this->l('VVV-Bon');
    ...
    public function install()
    {
        ...
        Configuration::updateValue('MULTISAFEPAY_VVVGIFTCARD_API_KEY', '');
        Configuration::updateValue('MULTISAFEPAY_VVVGIFTCARD_SANDBOX', '');
    ...
    {
        Configuration::deleteByName('MULTISAFEPAY_VVVGIFTCARD_API_KEY');
        Configuration::deleteByName('MULTISAFEPAY_VVVGIFTCARD_SANDBOX');
    ...
    public function getContent()
    {
        if (Tools::isSubmit('submit' . $this->name)) {
            Configuration::updateValue('MULTISAFEPAY_VVVGIFTCARD_API_KEY', Tools::getValue('MULTISAFEPAY_VVVGIFTCARD_API_KEY'));
            Configuration::updateValue('MULTISAFEPAY_VVVGIFTCARD_SANDBOX', Tools::getValue('MULTISAFEPAY_VVVGIFTCARD_SANDBOX'));
        }

        $CheckConnection = new CheckConnection('', '');
        $check = $CheckConnection->checkConnection(Tools::getValue('MULTISAFEPAY_VVVGIFTCARD_API_KEY'),
                                                    Tools::getValue('MULTISAFEPAY_VVVGIFTCARD_SANDBOX'));
        ...
        $fields_form[0]['form'] = [
            ...
            'input' => [
                [
                    ...
                    'name' => 'MULTISAFEPAY_VVVGIFTCARD_API_KEY',
                    'size' => 20,
                    'required' => false,
                ...
                [
                    ...
                    'name' => 'MULTISAFEPAY_VVVGIFTCARD_SANDBOX',
                    'class' => 't',
                    'is_bool' => true,
                    'required' => false,
        ...
        $helper->fields_value['MULTISAFEPAY_VVVGIFTCARD_API_KEY'] = Configuration::get('MULTISAFEPAY_VVVGIFTCARD_API_KEY');
        $helper->fields_value['MULTISAFEPAY_VVVGIFTCARD_SANDBOX'] = Configuration::get('MULTISAFEPAY_VVVGIFTCARD_SANDBOX');
