...
class Multisafepaywelnessgiftcard extends PaymentModule
{
    public function __construct()
    {
        ...
        $this->gateway = 'WELNESSGIFTCARD';
        $this->displayName = $this->l('Welness Giftcard');
    ...
    public function install()
    {
        ...
        Configuration::updateValue('MULTISAFEPAY_WELNESSGIFTCARD_API_KEY', '');
        Configuration::updateValue('MULTISAFEPAY_WELNESSGIFTCARD_SANDBOX', '');
    ...
    {
        Configuration::deleteByName('MULTISAFEPAY_WELNESSGIFTCARD_API_KEY');
        Configuration::deleteByName('MULTISAFEPAY_WELNESSGIFTCARD_SANDBOX');
    ...
    public function getContent()
    {
        if (Tools::isSubmit('submit' . $this->name)) {
            Configuration::updateValue('MULTISAFEPAY_WELNESSGIFTCARD_API_KEY', Tools::getValue('MULTISAFEPAY_WELNESSGIFTCARD_API_KEY'));
            Configuration::updateValue('MULTISAFEPAY_WELNESSGIFTCARD_SANDBOX', Tools::getValue('MULTISAFEPAY_WELNESSGIFTCARD_SANDBOX'));
        }

        $CheckConnection = new CheckConnection('', '');
        $check = $CheckConnection->checkConnection(Tools::getValue('MULTISAFEPAY_WELNESSGIFTCARD_API_KEY'),
                                                    Tools::getValue('MULTISAFEPAY_WELNESSGIFTCARD_SANDBOX'));
        ...
        $fields_form[0]['form'] = [
            ...
            'input' => [
                [
                    ...
                    'name' => 'MULTISAFEPAY_WELNESSGIFTCARD_API_KEY',
                    'size' => 20,
                    'required' => false,
                ...
                [
                    ...
                    'name' => 'MULTISAFEPAY_WELNESSGIFTCARD_SANDBOX',
                    'class' => 't',
                    'is_bool' => true,
                    'required' => false,
        ...
        $helper->fields_value['MULTISAFEPAY_WELNESSGIFTCARD_API_KEY'] = Configuration::get('MULTISAFEPAY_WELNESSGIFTCARD_API_KEY');
        $helper->fields_value['MULTISAFEPAY_WELNESSGIFTCARD_SANDBOX'] = Configuration::get('MULTISAFEPAY_WELNESSGIFTCARD_SANDBOX');
