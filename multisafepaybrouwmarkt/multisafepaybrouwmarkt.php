...
class Multisafepaybrouwmarkt extends PaymentModule
{
    public function __construct()
    {
        ...
        $this->gateway = 'BROUWMARKT';
        $this->displayName = $this->l('Brouwmarkt giftcard');
    ...
    {
        Configuration::deleteByName('MULTISAFEPAY_BROUWMARKT_API_KEY');
        Configuration::deleteByName('MULTISAFEPAY_BROUWMARKT_SANDBOX');
    ...
    public function getContent()
    {
        if (Tools::isSubmit('submit' . $this->name)) {
            Configuration::updateValue('MULTISAFEPAY_BROUWMARKT_API_KEY', Tools::getValue('MULTISAFEPAY_BROUWMARKT_API_KEY'));
            Configuration::updateValue('MULTISAFEPAY_BROUWMARKT_SANDBOX', Tools::getValue('MULTISAFEPAY_BROUWMARKT_SANDBOX'));
        }
        $CheckConnection = new CheckConnection('', '');
        $check = $CheckConnection->checkConnection(Tools::getValue('MULTISAFEPAY_BROUWMARKT_API_KEY'),
                                                    Tools::getValue('MULTISAFEPAY_BROUWMARKT_SANDBOX'));
        ...
        $fields_form[0]['form'] = [
            ...
            'input' => [
                [
                    ...
                    'name' => 'MULTISAFEPAY_BROUWMARKT_API_KEY',
                    'size' => 20,
                    'required' => false,
             ...
             [
                    ...
                    'name' => 'MULTISAFEPAY_BROUWMARKT_SANDBOX',
                    'class' => 't',
                    'is_bool' => true,
                    'required' => false,
        ...
        $helper->fields_value['MULTISAFEPAY_BROUWMARKT_API_KEY'] = Configuration::get('MULTISAFEPAY_BROUWMARKT_API_KEY');
        $helper->fields_value['MULTISAFEPAY_BROUWMARKT_SANDBOX'] = Configuration::get('MULTISAFEPAY_BROUWMARKT_SANDBOX');
