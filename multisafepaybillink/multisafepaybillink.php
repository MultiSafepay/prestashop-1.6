...
class MultisafepayBillink extends PaymentModule
{
    public $fee;
    public $gatewayTitle;
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('Billink');
    ...
    public function install()
    {
        ...
        Configuration::updateValue('MULTISAFEPAY_BILLINK_USE_COMPONENT', true);
    ...
    {
        Configuration::deleteByName('MULTISAFEPAY_BILLINK_MIN_AMOUNT');
        Configuration::deleteByName('MULTISAFEPAY_BILLINK_MAX_AMOUNT');
        Configuration::deleteByName('MULTISAFEPAY_BILLINK_USE_COMPONENT');
    ...
    public function hookPayment()
    {
        ...
        $min_amount = (int) Configuration::get('MULTISAFEPAY_BILLINK_MIN_AMOUNT');
        $max_amount = (int) Configuration::get('MULTISAFEPAY_BILLINK_MAX_AMOUNT');
        ...
        $useComponent = Configuration::get('MULTISAFEPAY_BILLINK_USE_COMPONENT');
    ...
    public function getContent()
    {
        if (Tools::isSubmit('submit' . $this->name)) {
            $min_amount = Tools::getValue('MULTISAFEPAY_BILLINK_MIN_AMOUNT');
            $max_amount = Tools::getValue('MULTISAFEPAY_BILLINK_MAX_AMOUNT');
            $useComponent = Tools::getValue('MULTISAFEPAY_BILLINK_USE_COMPONENT');

            Configuration::updateValue('MULTISAFEPAY_BILLINK_MIN_AMOUNT', $min_amount);
            Configuration::updateValue('MULTISAFEPAY_BILLINK_MAX_AMOUNT', $max_amount);
            Configuration::updateValue('MULTISAFEPAY_BILLINK_USE_COMPONENT', $useComponent);
        }
        ...
        $min_amount = Configuration::get('MULTISAFEPAY_BILLINK_MIN_AMOUNT');
        $max_amount = Configuration::get('MULTISAFEPAY_BILLINK_MAX_AMOUNT');
        $useComponent = Configuration::get('MULTISAFEPAY_BILLINK_USE_COMPONENT');

        $helper->fields_value['MULTISAFEPAY_BILLINK_MIN_AMOUNT'] = $min_amount;
        $helper->fields_value['MULTISAFEPAY_BILLINK_MAX_AMOUNT'] = $max_amount;
        $helper->fields_value['MULTISAFEPAY_BILLINK_USE_COMPONENT'] = $useComponent;
        ...
        $fields_form[0]['form'] = [
            ...
            'input' => [
                [
                    ...
                    'name' => 'MULTISAFEPAY_BILLINK_USE_COMPONENT',
                    'class' => 't',
                    'is_bool' => true,
                    'required' => true,
                ...
                [
                    ...
                    'label' => $this->l('Minimal order amount for Billink'),
                    'name' => 'MULTISAFEPAY_BILLINK_MIN_AMOUNT',
                    'required' => false,
                ],
                [
                    'type' => 'text',
                    'class' => 'fixed-width-sm',
                    'prefix' => $this->context->currency->sign,
                    'label' => $this->l('Maximum order amount for Billink'),
                    'name' => 'MULTISAFEPAY_BILLINK_MAX_AMOUNT',
                    'required' => false,
                ],
            ],
            'submit' => [
