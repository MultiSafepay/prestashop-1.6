...
class Multisafepaypodium extends PaymentModule
{
    public function __construct()
    {
        ...
        $this->gateway = 'PODIUMCADEAUKAART';
        $this->displayName = $this->l('Podium Cadeaukaart');
    ...
    public function install()
    {
        ...
        Configuration::updateValue('MULTISAFEPAY_PODIUM_API_KEY', '');
        Configuration::updateValue('MULTISAFEPAY_PODIUM_SANDBOX', '');
    ...
    {
        Configuration::deleteByName('MULTISAFEPAY_PODIUM_API_KEY');
        Configuration::deleteByName('MULTISAFEPAY_PODIUM_SANDBOX');
    ...
    public function getContent()
    {
        if (Tools::isSubmit('submit' . $this->name)) {
            Configuration::updateValue('MULTISAFEPAY_PODIUM_API_KEY', Tools::getValue('MULTISAFEPAY_PODIUM_API_KEY'));
            Configuration::updateValue('MULTISAFEPAY_PODIUM_SANDBOX', Tools::getValue('MULTISAFEPAY_PODIUM_SANDBOX'));
        }

        $CheckConnection = new CheckConnection('', '');
        $check = $CheckConnection->checkConnection(Tools::getValue('MULTISAFEPAY_PODIUM_API_KEY'),
                                                    Tools::getValue('MULTISAFEPAY_PODIUM_SANDBOX'));
        ...
        $fields_form[0]['form'] = [
            ...
            'input' => [
                [
                    ...
                    'name' => 'MULTISAFEPAY_PODIUM_API_KEY',
                    'size' => 20,
                    'required' => false,
                ...
                [
                    ...
                    'name' => 'MULTISAFEPAY_PODIUM_SANDBOX',
                    'class' => 't',
                    'is_bool' => true,
                    'required' => false,
        ...
        $helper->fields_value['MULTISAFEPAY_PODIUM_API_KEY'] = Configuration::get('MULTISAFEPAY_PODIUM_API_KEY');
        $helper->fields_value['MULTISAFEPAY_PODIUM_SANDBOX'] = Configuration::get('MULTISAFEPAY_PODIUM_SANDBOX');
