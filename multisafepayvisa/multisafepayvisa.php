...
class MultisafepayVisa extends PaymentModule
{
    ...
    public function install()
    {
        ...
        Configuration::updateValue('MULTISAFEPAY_VISA_USE_COMPONENT', true);
        Configuration::updateValue('MULTISAFEPAY_VISA_USE_TOKENIZATION', true);
    ...
    {
        Configuration::deleteByName('MULTISAFEPAY_VISA_MIN_AMOUNT');
        Configuration::deleteByName('MULTISAFEPAY_VISA_MAX_AMOUNT');
        Configuration::deleteByName('MULTISAFEPAY_VISA_USE_COMPONENT');
        Configuration::deleteByName('MULTISAFEPAY_VISA_USE_TOKENIZATION');
    ...
    public function hookPayment()
    {
        ...
        $min_amount = (int) Configuration::get('MULTISAFEPAY_VISA_MIN_AMOUNT');
        $max_amount = (int) Configuration::get('MULTISAFEPAY_VISA_MAX_AMOUNT');
        ...
        // TODO: figure out why CSS and JS is not being loaded from main module.
        ...
        if (!$customer->is_guest) {
            $useTokenization = Configuration::get('MULTISAFEPAY_VISA_USE_TOKENIZATION');
        }

        $useComponent = Configuration::get('MULTISAFEPAY_VISA_USE_COMPONENT');
    ...
    public function getContent()
    {
        if (Tools::isSubmit('submit' . $this->name)) {
            $min_amount = Tools::getValue('MULTISAFEPAY_VISA_MIN_AMOUNT');
            $max_amount = Tools::getValue('MULTISAFEPAY_VISA_MAX_AMOUNT');
            $useComponent = Tools::getValue('MULTISAFEPAY_VISA_USE_COMPONENT');
            $useTokenization = Tools::getValue('MULTISAFEPAY_VISA_USE_TOKENIZATION');

            Configuration::updateValue('MULTISAFEPAY_VISA_MIN_AMOUNT', $min_amount);
            Configuration::updateValue('MULTISAFEPAY_VISA_MAX_AMOUNT', $max_amount);
            Configuration::updateValue('MULTISAFEPAY_VISA_USE_COMPONENT', $useComponent);
            Configuration::updateValue('MULTISAFEPAY_VISA_USE_TOKENIZATION', $useTokenization);
        }
        ...
        $min_amount = Configuration::get('MULTISAFEPAY_VISA_MIN_AMOUNT');
        $max_amount = Configuration::get('MULTISAFEPAY_VISA_MAX_AMOUNT');
        $useComponent = Configuration::get('MULTISAFEPAY_VISA_USE_COMPONENT');
        $useTokenization = Configuration::get('MULTISAFEPAY_VISA_USE_TOKENIZATION');

        $helper->fields_value['MULTISAFEPAY_VISA_MIN_AMOUNT'] = $min_amount;
        $helper->fields_value['MULTISAFEPAY_VISA_MAX_AMOUNT'] = $max_amount;
        $helper->fields_value['MULTISAFEPAY_VISA_USE_COMPONENT'] = $useComponent;
        $helper->fields_value['MULTISAFEPAY_VISA_USE_TOKENIZATION'] = $useTokenization;
        ...
        $fields_form[0]['form'] = [
            ...
            'input' => [
                [
                    ...
                    'name' => 'MULTISAFEPAY_VISA_USE_COMPONENT',
                    'class' => 't',
                    'is_bool' => true,
                    'required' => true,
                ...
                [
                    ...
                    'name' => 'MULTISAFEPAY_VISA_USE_TOKENIZATION',
                    'class' => 't',
                    'is_bool' => true,
                    'required' => true,
                ...
                [
                    ...
                    'label' => $this->l('Minimal order amount for VISA'),
                    'name' => 'MULTISAFEPAY_VISA_MIN_AMOUNT',
                    'required' => false,
                ],
                [
                    'type' => 'text',
                    'class' => 'fixed-width-sm',
                    'prefix' => $this->context->currency->sign,
                    'label' => $this->l('Maximum order amount for VISA'),
                    'name' => 'MULTISAFEPAY_VISA_MAX_AMOUNT',
                    'required' => false,
                ],
            ],
            'submit' => [
