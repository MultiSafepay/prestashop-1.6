...
class MultisafepayBanktrans extends PaymentModule
{
    public function __construct()
    {
        ...
        $this->name = 'multisafepaybanktrans';
        ...
        $this->displayName = $this->l('Banktransfer');
    ...
    {
        Configuration::deleteByName('MULTISAFEPAY_BANKTRANS_MIN_AMOUNT');
        Configuration::deleteByName('MULTISAFEPAY_BANKTRANS_MAX_AMOUNT');
    ...
    public function hookPayment()
    {
        ...
        $min_amount = (int) Configuration::get('MULTISAFEPAY_BANKTRANS_MIN_AMOUNT');
        $max_amount = (int) Configuration::get('MULTISAFEPAY_BANKTRANS_MAX_AMOUNT');
    ...
    public function getContent()
    {
        if (Tools::isSubmit('submit' . $this->name)) {
            Configuration::updateValue('MULTISAFEPAY_BANKTRANS_MIN_AMOUNT', Tools::getValue('MULTISAFEPAY_BANKTRANS_MIN_AMOUNT'));
            Configuration::updateValue('MULTISAFEPAY_BANKTRANS_MAX_AMOUNT', Tools::getValue('MULTISAFEPAY_BANKTRANS_MAX_AMOUNT'));
        }
        ...
        $fields_form[0]['form'] = [
            ...
            'input' => [
                [
                    ...
                    'label' => $this->l('Minimal order amount for Banktransfer'),
                    'name' => 'MULTISAFEPAY_BANKTRANS_MIN_AMOUNT',
                    'required' => false,
                ],
                [
                    'type' => 'text',
                    'class' => 'fixed-width-sm',
                    'prefix' => $this->context->currency->sign,
                    'label' => $this->l('Maximum order amount for Banktransfer'),
                    'name' => 'MULTISAFEPAY_BANKTRANS_MAX_AMOUNT',
                    'required' => false,
                ],
            ],
            'submit' => [
        ...
        $helper->fields_value['MULTISAFEPAY_BANKTRANS_MIN_AMOUNT'] = Configuration::get('MULTISAFEPAY_BANKTRANS_MIN_AMOUNT');
        $helper->fields_value['MULTISAFEPAY_BANKTRANS_MAX_AMOUNT'] = Configuration::get('MULTISAFEPAY_BANKTRANS_MAX_AMOUNT');
