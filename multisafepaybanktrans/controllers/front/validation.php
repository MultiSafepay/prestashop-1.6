...
class MultisafepayBanktransValidationModuleFrontController extends MultisafepayValidationModuleFrontController
{
    public function postProcess()
    {
        if (Configuration::get('MULTISAFEPAY_BANKTRANS_DIRECT')) {
            $this->type = 'direct';
        } else {
            $this->type = 'redirect';
        }
