...
class Multisafepaywijncadeau extends PaymentModule
{
    public function __construct()
    {
        ...
        $this->name = 'multisafepaywijncadeau';
        ...
        $this->displayName = $this->l('Wijncadeau');
    ...
    public function install()
    {
        ...
        Configuration::updateValue('MULTISAFEPAY_WIJNCADEAU_API_KEY', '');
        Configuration::updateValue('MULTISAFEPAY_WIJNCADEAU_SANDBOX', '');
    ...
    {
        Configuration::deleteByName('MULTISAFEPAY_WIJNCADEAU_API_KEY');
        Configuration::deleteByName('MULTISAFEPAY_WIJNCADEAU_SANDBOX');
    ...
    public function getContent()
    {
        if (Tools::isSubmit('submit' . $this->name)) {
            Configuration::updateValue('MULTISAFEPAY_WIJNCADEAU_API_KEY', Tools::getValue('MULTISAFEPAY_WIJNCADEAU_API_KEY'));
            Configuration::updateValue('MULTISAFEPAY_WIJNCADEAU_SANDBOX', Tools::getValue('MULTISAFEPAY_WIJNCADEAU_SANDBOX'));
        }

        $CheckConnection = new CheckConnection('', '');
        $check = $CheckConnection->checkConnection(Tools::getValue('MULTISAFEPAY_WIJNCADEAU_API_KEY'),
                                                    Tools::getValue('MULTISAFEPAY_WIJNCADEAU_SANDBOX'));
        ...
        $fields_form[0]['form'] = [
            ...
            'input' => [
                [
                    ...
                    'name' => 'MULTISAFEPAY_WIJNCADEAU_API_KEY',
                    'size' => 20,
                    'required' => false,
                ...
                [
                    ...
                    'name' => 'MULTISAFEPAY_WIJNCADEAU_SANDBOX',
                    'class' => 't',
                    'is_bool' => true,
                    'required' => false,
        ...
        $helper->fields_value['MULTISAFEPAY_WIJNCADEAU_API_KEY'] = Configuration::get('MULTISAFEPAY_WIJNCADEAU_API_KEY');
        $helper->fields_value['MULTISAFEPAY_WIJNCADEAU_SANDBOX'] = Configuration::get('MULTISAFEPAY_WIJNCADEAU_SANDBOX');
