...
class MultisafepayBNPLInstallments extends PaymentModule
{
    ...
    public function install()
    {
        ...
        Configuration::updateValue('MULTISAFEPAY_BNPL_INSTM_USE_COMPONENT', true);
    ...
    public function uninstall()
    {
        ...
        Configuration::deleteByName('MULTISAFEPAY_BNPL_INSTM_MIN_AMOUNT');
        Configuration::deleteByName('MULTISAFEPAY_BNPL_INSTM_MAX_AMOUNT');
        Configuration::deleteByName('MULTISAFEPAY_BNPL_INSTM_USE_COMPONENT');
    ...
    public function getContent()
    {
        if (Tools::isSubmit('submit' . $this->name)) {
            Configuration::updateValue('MULTISAFEPAY_BNPL_INSTM_MIN_AMOUNT', Tools::getValue('MULTISAFEPAY_BNPL_INSTM_MIN_AMOUNT'));
            Configuration::updateValue('MULTISAFEPAY_BNPL_INSTM_MAX_AMOUNT', Tools::getValue('MULTISAFEPAY_BNPL_INSTM_MAX_AMOUNT'));
            Configuration::updateValue('MULTISAFEPAY_BNPL_INSTM_USE_COMPONENT', Tools::getValue('MULTISAFEPAY_BNPL_INSTM_USE_COMPONENT'));
        }
        ...
        $fields_form[0]['form'] = [
            ...
            'input' => [
                [
                    ...
                    'name' => 'MULTISAFEPAY_BNPL_INSTM_USE_COMPONENT',
                    'class' => 't',
                    'is_bool' => true,
                    'required' => true,
                ...
                [
                    ...
                    'name' => 'MULTISAFEPAY_BNPL_INSTM_MIN_AMOUNT',
                    'required' => false,
                ],
                [
                    'type' => 'text',
                    'class' => 'fixed-width-sm',
                    'prefix' => $this->context->currency->sign,
                    'label' => $this->l('Maximum order amount for BNPL Installment'),
                    'name' => 'MULTISAFEPAY_BNPL_INSTM_MAX_AMOUNT',
                    'required' => false,
                ],
            ],
            'submit' => [
        ...
        $helper->fields_value['MULTISAFEPAY_BNPL_INSTM_MIN_AMOUNT'] = Configuration::get('MULTISAFEPAY_BNPL_INSTM_MIN_AMOUNT');
        $helper->fields_value['MULTISAFEPAY_BNPL_INSTM_MAX_AMOUNT'] = Configuration::get('MULTISAFEPAY_BNPL_INSTM_MAX_AMOUNT');
        $helper->fields_value['MULTISAFEPAY_BNPL_INSTM_USE_COMPONENT'] = Configuration::get('MULTISAFEPAY_BNPL_INSTM_USE_COMPONENT');
