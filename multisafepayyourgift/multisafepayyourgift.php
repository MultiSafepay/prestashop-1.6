...
class Multisafepayyourgift extends PaymentModule
{
    public function __construct()
    {
        ...
        $this->gateway = 'YOURGIFTCARD';
        $this->displayName = $this->l('Yourgiftcard');
    ...
    public function install()
    {
        ...
        Configuration::updateValue('MULTISAFEPAY_YOURGIFT_API_KEY', '');
        Configuration::updateValue('MULTISAFEPAY_YOURGIFT_SANDBOX', '');
    ...
    {
        Configuration::deleteByName('MULTISAFEPAY_YOURGIFT_API_KEY');
        Configuration::deleteByName('MULTISAFEPAY_YOURGIFT_SANDBOX');
    ...
    public function getContent()
    {
        if (Tools::isSubmit('submit' . $this->name)) {
            Configuration::updateValue('MULTISAFEPAY_YOURGIFT_API_KEY', Tools::getValue('MULTISAFEPAY_YOURGIFT_API_KEY'));
            Configuration::updateValue('MULTISAFEPAY_YOURGIFT_SANDBOX', Tools::getValue('MULTISAFEPAY_YOURGIFT_SANDBOX'));
        }

        $CheckConnection = new CheckConnection('', '');
        $check = $CheckConnection->checkConnection(Tools::getValue('MULTISAFEPAY_YOURGIFT_API_KEY'),
                                                    Tools::getValue('MULTISAFEPAY_YOURGIFT_SANDBOX'));
        ...
        $fields_form[0]['form'] = [
            ...
            'input' => [
                [
                    ...
                    'name' => 'MULTISAFEPAY_YOURGIFT_API_KEY',
                    'size' => 20,
                    'required' => false,
                ...
                [
                    ...
                    'name' => 'MULTISAFEPAY_YOURGIFT_SANDBOX',
                    'class' => 't',
                    'is_bool' => true,
                    'required' => false,
        ...
        $helper->fields_value['MULTISAFEPAY_YOURGIFT_API_KEY'] = Configuration::get('MULTISAFEPAY_YOURGIFT_API_KEY');
        $helper->fields_value['MULTISAFEPAY_YOURGIFT_SANDBOX'] = Configuration::get('MULTISAFEPAY_YOURGIFT_SANDBOX');
