...
class Multisafepaygood4fun extends PaymentModule
{
    public function __construct()
    {
        ...
        $this->name = 'multisafepaygood4fun';
        ...
        $this->gateway = 'GOOD4FUN';
        $this->displayName = $this->l('Good4fun Giftcard');
    ...
    public function install()
    {
        ...
        Configuration::updateValue('MULTISAFEPAY_GOOD4FUN_API_KEY', '');
        Configuration::updateValue('MULTISAFEPAY_GOOD4FUN_SANDBOX', '');
    ...
    {
        Configuration::deleteByName('MULTISAFEPAY_GOOD4FUN_API_KEY');
        Configuration::deleteByName('MULTISAFEPAY_GOOD4FUN_SANDBOX');
    ...
    public function getContent()
    {
        if (Tools::isSubmit('submit' . $this->name)) {
            Configuration::updateValue('MULTISAFEPAY_GOOD4FUN_API_KEY', Tools::getValue('MULTISAFEPAY_GOOD4FUN_API_KEY'));
            Configuration::updateValue('MULTISAFEPAY_GOOD4FUN_SANDBOX', Tools::getValue('MULTISAFEPAY_GOOD4FUN_SANDBOX'));
        }

        $CheckConnection = new CheckConnection('', '');
        $check = $CheckConnection->checkConnection(Tools::getValue('MULTISAFEPAY_GOOD4FUN_API_KEY'),
            Tools::getValue('MULTISAFEPAY_GOOD4FUN_SANDBOX'));
        ...
        $fields_form[0]['form'] = [
            ...
            'input' => [
                [
                    ...
                    'name' => 'MULTISAFEPAY_GOOD4FUN_API_KEY',
                    'size' => 20,
                    'required' => false,
                ...
                [
                    ...
                    'name' => 'MULTISAFEPAY_GOOD4FUN_SANDBOX',
                    'class' => 't',
                    'is_bool' => true,
                    'required' => false,
        ...
        $helper->fields_value['MULTISAFEPAY_GOOD4FUN_API_KEY'] = Configuration::get('MULTISAFEPAY_GOOD4FUN_API_KEY');
        $helper->fields_value['MULTISAFEPAY_GOOD4FUN_SANDBOX'] = Configuration::get('MULTISAFEPAY_GOOD4FUN_SANDBOX');
