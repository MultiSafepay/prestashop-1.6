...
class Multisafepaydegrotespeelgoedwinkel extends PaymentModule
{
    public function __construct()
    {
        ...
        $this->gateway = 'DEGROTESPEELGOEDWINKEL';
        $this->displayName = $this->l('De grote Speelgoedwinkel');
    ...
    public function install()
    {
        ...
        Configuration::updateValue('MULTISAFEPAY_DEGROTESPEELGOEDWINKEL_API_KEY', '');
        Configuration::updateValue('MULTISAFEPAY_DEGROTESPEELGOEDWINKEL_SANDBOX', '');
    ...
    {
        Configuration::deleteByName('MULTISAFEPAY_DEGROTESPEELGOEDWINKEL_API_KEY');
        Configuration::deleteByName('MULTISAFEPAY_DEGROTESPEELGOEDWINKEL_SANDBOX');
    ...
    public function getContent()
    {
        if (Tools::isSubmit('submit' . $this->name)) {
            Configuration::updateValue('MULTISAFEPAY_DEGROTESPEELGOEDWINKEL_API_KEY', Tools::getValue('MULTISAFEPAY_DEGROTESPEELGOEDWINKEL_API_KEY'));
            Configuration::updateValue('MULTISAFEPAY_DEGROTESPEELGOEDWINKEL_SANDBOX', Tools::getValue('MULTISAFEPAY_DEGROTESPEELGOEDWINKEL_SANDBOX'));
        }

        $CheckConnection = new CheckConnection('', '');
        $check = $CheckConnection->checkConnection(Tools::getValue('MULTISAFEPAY_DEGROTESPEELGOEDWINKEL_API_KEY'),
                                                    Tools::getValue('MULTISAFEPAY_DEGROTESPEELGOEDWINKEL_SANDBOX'));
        ...
        $fields_form[0]['form'] = [
            ...
            'input' => [
                [
                    ...
                    'name' => 'MULTISAFEPAY_DEGROTESPEELGOEDWINKEL_API_KEY',
                    'size' => 20,
                    'required' => false,
             ...
             [
                    ...
                    'name' => 'MULTISAFEPAY_DEGROTESPEELGOEDWINKEL_SANDBOX',
                    'class' => 't',
                    'is_bool' => true,
                    'required' => false,
        ...
        $helper->fields_value['MULTISAFEPAY_DEGROTESPEELGOEDWINKEL_API_KEY'] = Configuration::get('MULTISAFEPAY_DEGROTESPEELGOEDWINKEL_API_KEY');
        $helper->fields_value['MULTISAFEPAY_DEGROTESPEELGOEDWINKEL_SANDBOX'] = Configuration::get('MULTISAFEPAY_DEGROTESPEELGOEDWINKEL_SANDBOX');
