...
class MultiSafepayBizum extends PaymentModule
{
    public $fee;
    public $gatewayTitle;
    ...
    public function uninstall()
    {
        ...
        Configuration::deleteByName('MULTISAFEPAY_BIZUM_MIN_AMOUNT');
        Configuration::deleteByName('MULTISAFEPAY_BIZUM_MAX_AMOUNT');
    ...
    public function hookPayment()
    {
        ...
        $min_amount = (int) Configuration::get('MULTISAFEPAY_BIZUM_MIN_AMOUNT');
        $max_amount = (int) Configuration::get('MULTISAFEPAY_BIZUM_MAX_AMOUNT');
    ...
    public function getContent()
    {
        if (Tools::isSubmit('submit' . $this->name)) {
            Configuration::updateValue('MULTISAFEPAY_BIZUM_MIN_AMOUNT', Tools::getValue('MULTISAFEPAY_BIZUM_MIN_AMOUNT'));
            Configuration::updateValue('MULTISAFEPAY_BIZUM_MAX_AMOUNT', Tools::getValue('MULTISAFEPAY_BIZUM_MAX_AMOUNT'));
        }
        ...
        $fields_form[0]['form'] = [
            ...
            'input' => [
                [
                    ...
                    'label' => $this->l('Minimal order amount for Bizum'),
                    'name' => 'MULTISAFEPAY_BIZUM_MIN_AMOUNT',
                    'required' => false,
                ],
                [
                    'type' => 'text',
                    'class' => 'fixed-width-sm',
                    'prefix' => $this->context->currency->sign,
                    'label' => $this->l('Maximum order amount for Bizum'),
                    'name' => 'MULTISAFEPAY_BIZUM_MAX_AMOUNT',
                    'required' => false,
                ],
            ],
            'submit' => [
        ...
        $helper->fields_value['MULTISAFEPAY_BIZUM_MIN_AMOUNT'] = Configuration::get('MULTISAFEPAY_BIZUM_MIN_AMOUNT');
        $helper->fields_value['MULTISAFEPAY_BIZUM_MAX_AMOUNT'] = Configuration::get('MULTISAFEPAY_BIZUM_MAX_AMOUNT');
