...
class MultisafepayZinia extends PaymentModule
{
    ...
    {
        Configuration::deleteByName('MULTISAFEPAY_ZINIA_MIN_AMOUNT');
        Configuration::deleteByName('MULTISAFEPAY_ZINIA_MAX_AMOUNT');
    ...
    public function getContent()
    {
        if (Tools::isSubmit('submit' . $this->name)) {
            $min_amount = Tools::getValue('MULTISAFEPAY_ZINIA_MIN_AMOUNT');
            $max_amount = Tools::getValue('MULTISAFEPAY_ZINIA_MAX_AMOUNT');

            Configuration::updateValue('MULTISAFEPAY_ZINIA_MIN_AMOUNT', $min_amount);
            Configuration::updateValue('MULTISAFEPAY_ZINIA_MAX_AMOUNT', $max_amount);
        }
        ...
        $min_amount = Configuration::get('MULTISAFEPAY_ZINIA_MIN_AMOUNT');
        $max_amount = Configuration::get('MULTISAFEPAY_ZINIA_MAX_AMOUNT');
        ...
        $fields_form[0]['form'] = [
            ...
            'input' => [
                [
                    ...
                    'name' => 'MULTISAFEPAY_ZINIA_MIN_AMOUNT',
                    'required' => false,
                ],
                [
                    'type' => 'text',
                    ...
                    'name' => 'MULTISAFEPAY_ZINIA_MAX_AMOUNT',
                    'required' => false,
                ],
            ],
            'submit' => [
        ...
        $helper->fields_value['MULTISAFEPAY_ZINIA_MIN_AMOUNT'] = $min_amount;
        $helper->fields_value['MULTISAFEPAY_ZINIA_MAX_AMOUNT'] = $max_amount;
