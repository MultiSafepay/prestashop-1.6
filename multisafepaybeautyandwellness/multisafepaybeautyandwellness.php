...
class Multisafepaybeautyandwellness extends PaymentModule
{
    public function __construct()
    {
        ...
        $this->displayName = $this->l('Beauty and Wellness giftcard');
    ...
    {
        Configuration::deleteByName('MULTISAFEPAY_BEAUTYANDWELLNESS_API_KEY');
        Configuration::deleteByName('MULTISAFEPAY_BEAUTYANDWELLNESS_SANDBOX');
    ...
    public function getContent()
    {
        if (Tools::isSubmit('submit' . $this->name)) {
            Configuration::updateValue('MULTISAFEPAY_BEAUTYANDWELLNESS_API_KEY', Tools::getValue('MULTISAFEPAY_BEAUTYANDWELLNESS_API_KEY'));
            Configuration::updateValue('MULTISAFEPAY_BEAUTYANDWELLNESS_SANDBOX', Tools::getValue('MULTISAFEPAY_BEAUTYANDWELLNESS_SANDBOX'));
        }

        $CheckConnection = new CheckConnection('', '');
        $check = $CheckConnection->checkConnection(Tools::getValue('MULTISAFEPAY_BEAUTYANDWELLNESS_API_KEY'),
                                                    Tools::getValue('MULTISAFEPAY_BEAUTYANDWELLNESS_SANDBOX'));
        ...
        $fields_form[0]['form'] = [
            ...
            'input' => [
                [
                    ...
                    'name' => 'MULTISAFEPAY_BEAUTYANDWELLNESS_API_KEY',
                    'size' => 20,
                    'required' => false,
                ...
                [
                    ...
                    'name' => 'MULTISAFEPAY_BEAUTYANDWELLNESS_SANDBOX',
                    'class' => 't',
                    'is_bool' => true,
                    'required' => false,
        ...
        $helper->fields_value['MULTISAFEPAY_BEAUTYANDWELLNESS_API_KEY'] = Configuration::get('MULTISAFEPAY_BEAUTYANDWELLNESS_API_KEY');
        $helper->fields_value['MULTISAFEPAY_BEAUTYANDWELLNESS_SANDBOX'] = Configuration::get('MULTISAFEPAY_BEAUTYANDWELLNESS_SANDBOX');
