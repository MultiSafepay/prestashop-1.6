...
class MultisafepayConnect extends PaymentModule
{
    public function __construct()
    {
        ...
        $this->gateway = '';
        $this->displayName = $this->l('Connect');
    ...
    {
        Configuration::deleteByName('MULTISAFEPAY_CONNECT_MIN_AMOUNT');
        Configuration::deleteByName('MULTISAFEPAY_CONNECT_MAX_AMOUNT');
    ...
    public function hookPayment()
    {
        ...
        $min_amount = (int) Configuration::get('MULTISAFEPAY_CONNECT_MIN_AMOUNT');
        $max_amount = (int) Configuration::get('MULTISAFEPAY_CONNECT_MAX_AMOUNT');
    ...
    public function getContent()
    {
        if (Tools::isSubmit('submit' . $this->name)) {
            $min_amount = Tools::getValue('MULTISAFEPAY_CONNECT_MIN_AMOUNT');
            $max_amount = Tools::getValue('MULTISAFEPAY_CONNECT_MAX_AMOUNT');
            Configuration::updateValue('MULTISAFEPAY_CONNECT_MIN_AMOUNT', $min_amount);
            Configuration::updateValue('MULTISAFEPAY_CONNECT_MAX_AMOUNT', $max_amount);
        }

        $default_lang = (int) Configuration::get('PS_LANG_DEFAULT');
//        $this->default_currency = MultiSafepay::getDefaultCurrency();
        ...
        $fields_form = [];
        $min_amount = Configuration::get('MULTISAFEPAY_CONNECT_MIN_AMOUNT');
        $max_amount = Configuration::get('MULTISAFEPAY_CONNECT_MAX_AMOUNT');
        $fields_form[0]['form'] = [
            'legend' => [
            ...
            'input' => [
                [
                    ...
                    'label' => $this->l('Minimal order amount'),
                    'name' => 'MULTISAFEPAY_CONNECT_MIN_AMOUNT',
                    'required' => false,
                ],
                [
                    'type' => 'text',
                    ...
                    'name' => 'MULTISAFEPAY_CONNECT_MAX_AMOUNT',
                    'required' => false,
                ],
            ],
            'submit' => [
        ...
        $helper->fields_value['MULTISAFEPAY_CONNECT_MIN_AMOUNT'] = $min_amount;
        $helper->fields_value['MULTISAFEPAY_CONNECT_MAX_AMOUNT'] = $max_amount;
