...
class Multisafepayfashioncheque extends PaymentModule
{
    public function __construct()
    {
        ...
        $this->gateway = 'FASHIONCHEQUE';
        $this->displayName = $this->l('FashionCheque');
    ...
    public function install()
    {
        ...
        Configuration::updateValue('MULTISAFEPAY_FASHIONCHEQUE_API_KEY', '');
        Configuration::updateValue('MULTISAFEPAY_FASHIONCHEQUE_SANDBOX', '');
    ...
    {
        Configuration::deleteByName('MULTISAFEPAY_FASHIONCHEQUE_API_KEY');
        Configuration::deleteByName('MULTISAFEPAY_FASHIONCHEQUE_SANDBOX');
    ...
    public function getContent()
    {
        if (Tools::isSubmit('submit' . $this->name)) {
            Configuration::updateValue('MULTISAFEPAY_FASHIONCHEQUE_API_KEY', Tools::getValue('MULTISAFEPAY_FASHIONCHEQUE_API_KEY'));
            Configuration::updateValue('MULTISAFEPAY_FASHIONCHEQUE_SANDBOX', Tools::getValue('MULTISAFEPAY_FASHIONCHEQUE_SANDBOX'));
        }

        $CheckConnection = new CheckConnection('', '');
        $check = $CheckConnection->checkConnection(Tools::getValue('MULTISAFEPAY_FASHIONCHEQUE_API_KEY'),
                                                    Tools::getValue('MULTISAFEPAY_FASHIONCHEQUE_SANDBOX'));
        ...
        $fields_form[0]['form'] = [
            ...
            'input' => [
                [
                    ...
                    'name' => 'MULTISAFEPAY_FASHIONCHEQUE_API_KEY',
                    'size' => 20,
                    'required' => false,
             ...
             [
                    ...
                    'name' => 'MULTISAFEPAY_FASHIONCHEQUE_SANDBOX',
                    'class' => 't',
                    'is_bool' => true,
                    'required' => false,
        ...
        $helper->fields_value['MULTISAFEPAY_FASHIONCHEQUE_API_KEY'] = Configuration::get('MULTISAFEPAY_FASHIONCHEQUE_API_KEY');
        $helper->fields_value['MULTISAFEPAY_FASHIONCHEQUE_SANDBOX'] = Configuration::get('MULTISAFEPAY_FASHIONCHEQUE_SANDBOX');
