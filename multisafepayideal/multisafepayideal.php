...
class MultiSafepayIdeal extends PaymentModule
{
    ...
    public function uninstall()
    {
        ...
        Configuration::deleteByName('MULTISAFEPAY_IDEAL_MIN_AMOUNT');
        Configuration::deleteByName('MULTISAFEPAY_IDEAL_MAX_AMOUNT');
    ...
    public function hookPayment()
    {
        ...
        $min_amount = (int) Configuration::get('MULTISAFEPAY_IDEAL_MIN_AMOUNT');
        $max_amount = (int) Configuration::get('MULTISAFEPAY_IDEAL_MAX_AMOUNT');
    ...
    public function getContent()
    {
        if (Tools::isSubmit('submit' . $this->name)) {
            Configuration::updateValue('MULTISAFEPAY_IDEAL_MIN_AMOUNT', Tools::getValue('MULTISAFEPAY_IDEAL_MIN_AMOUNT'));
            Configuration::updateValue('MULTISAFEPAY_IDEAL_MAX_AMOUNT', Tools::getValue('MULTISAFEPAY_IDEAL_MAX_AMOUNT'));
        }
        ...
        $fields_form[0]['form'] = [
            ...
            'input' => [
                [
                    ...
                    'label' => $this->l('Minimal order amount for IDEAL'),
                    'name' => 'MULTISAFEPAY_IDEAL_MIN_AMOUNT',
                    'required' => false,
                ],
                [
                    'type' => 'text',
                    'class' => 'fixed-width-sm',
                    'prefix' => $this->context->currency->sign,
                    'label' => $this->l('Maximum order amount for IDEAL'),
                    'name' => 'MULTISAFEPAY_IDEAL_MAX_AMOUNT',
                    'required' => false,
                ],
            ],
            'submit' => [
        ...
        $helper->fields_value['MULTISAFEPAY_IDEAL_MIN_AMOUNT'] = Configuration::get('MULTISAFEPAY_IDEAL_MIN_AMOUNT');
        $helper->fields_value['MULTISAFEPAY_IDEAL_MAX_AMOUNT'] = Configuration::get('MULTISAFEPAY_IDEAL_MAX_AMOUNT');
