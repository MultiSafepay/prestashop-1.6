...
class Multisafepaywebshopgiftcard extends PaymentModule
{
    public function __construct()
    {
        ...
        $this->name = 'multisafepaywebshopgiftcard';
        ...
        $this->displayName = $this->l('Webshop Giftcard');
    ...
    public function install()
    {
        ...
        Configuration::updateValue('MULTISAFEPAY_WEBSHOPGIFTCARD_API_KEY', '');
        Configuration::updateValue('MULTISAFEPAY_WEBSHOPGIFTCARD_SANDBOX', '');
    ...
    {
        Configuration::deleteByName('MULTISAFEPAY_WEBSHOPGIFTCARD_API_KEY');
        Configuration::deleteByName('MULTISAFEPAY_WEBSHOPGIFTCARD_SANDBOX');
    ...
    public function getContent()
    {
        if (Tools::isSubmit('submit' . $this->name)) {
            Configuration::updateValue('MULTISAFEPAY_WEBSHOPGIFTCARD_API_KEY', Tools::getValue('MULTISAFEPAY_WEBSHOPGIFTCARD_API_KEY'));
            Configuration::updateValue('MULTISAFEPAY_WEBSHOPGIFTCARD_SANDBOX', Tools::getValue('MULTISAFEPAY_WEBSHOPGIFTCARD_SANDBOX'));
        }

        $CheckConnection = new CheckConnection('', '');
        $check = $CheckConnection->checkConnection(Tools::getValue('MULTISAFEPAY_WEBSHOPGIFTCARD_API_KEY'),
                                                    Tools::getValue('MULTISAFEPAY_WEBSHOPGIFTCARD_SANDBOX'));
        ...
        $fields_form[0]['form'] = [
            ...
            'input' => [
                [
                    ...
                    'name' => 'MULTISAFEPAY_WEBSHOPGIFTCARD_API_KEY',
                    'size' => 20,
                    'required' => false,
                ...
                [
                    ...
                    'name' => 'MULTISAFEPAY_WEBSHOPGIFTCARD_SANDBOX',
                    'class' => 't',
                    'is_bool' => true,
                    'required' => false,
        ...
        $helper->fields_value['MULTISAFEPAY_WEBSHOPGIFTCARD_API_KEY'] = Configuration::get('MULTISAFEPAY_WEBSHOPGIFTCARD_API_KEY');
        $helper->fields_value['MULTISAFEPAY_WEBSHOPGIFTCARD_SANDBOX'] = Configuration::get('MULTISAFEPAY_WEBSHOPGIFTCARD_SANDBOX');
