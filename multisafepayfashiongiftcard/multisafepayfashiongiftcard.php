...
class Multisafepayfashiongiftcard extends PaymentModule
{
    public function __construct()
    {
        ...
        $this->name = 'multisafepayfashiongiftcard';
        ...
        $this->gateway = 'FASHIONGIFTCARD';
        $this->displayName = $this->l('Fashion giftcard');
    ...
    public function install()
    {
        ...
        Configuration::updateValue('MULTISAFEPAY_FASHIONGIFTCARD_API_KEY', '');
        Configuration::updateValue('MULTISAFEPAY_FASHIONGIFTCARD_SANDBOX', '');
    ...
    {
        Configuration::deleteByName('MULTISAFEPAY_FASHIONGIFTCARD_API_KEY');
        Configuration::deleteByName('MULTISAFEPAY_FASHIONGIFTCARD_SANDBOX');
    ...
    public function getContent()
    {
        if (Tools::isSubmit('submit' . $this->name)) {
            Configuration::updateValue('MULTISAFEPAY_FASHIONGIFTCARD_API_KEY', Tools::getValue('MULTISAFEPAY_FASHIONGIFTCARD_API_KEY'));
            Configuration::updateValue('MULTISAFEPAY_FASHIONGIFTCARD_SANDBOX', Tools::getValue('MULTISAFEPAY_FASHIONGIFTCARD_SANDBOX'));
        }

        $CheckConnection = new CheckConnection('', '');
        $check = $CheckConnection->checkConnection(Tools::getValue('MULTISAFEPAY_FASHIONGIFTCARD_API_KEY'),
                                                    Tools::getValue('MULTISAFEPAY_FASHIONGIFTCARD_SANDBOX'));
        ...
        $fields_form[0]['form'] = [
            ...
            'input' => [
                [
                    ...
                    'name' => 'MULTISAFEPAY_FASHIONGIFTCARD_API_KEY',
                    'size' => 20,
                    'required' => false,
              ...
              [
                    ...
                    'name' => 'MULTISAFEPAY_FASHIONGIFTCARD_SANDBOX',
                    'class' => 't',
                    'is_bool' => true,
                    'required' => false,
        ...
        $helper->fields_value['MULTISAFEPAY_FASHIONGIFTCARD_API_KEY'] = Configuration::get('MULTISAFEPAY_FASHIONGIFTCARD_API_KEY');
        $helper->fields_value['MULTISAFEPAY_FASHIONGIFTCARD_SANDBOX'] = Configuration::get('MULTISAFEPAY_FASHIONGIFTCARD_SANDBOX');
