...
class MultiSafepayAlipay extends PaymentModule
{
    public function __construct()
    {
        ...
        $this->description = $this->l('This module allows you to accept Alipay payments through MultiSafepay.');
    ...
    public function hookPayment()
    {
        ...
        $min_amount = (int) Configuration::get('MULTISAFEPAY_ALIPAY_MIN_AMOUNT');
        $max_amount = (int) Configuration::get('MULTISAFEPAY_ALIPAY_MAX_AMOUNT');
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submit' . $this->name)) {
            Configuration::updateValue(
                'MULTISAFEPAY_ALIPAY_MIN_AMOUNT',
                Tools::getValue('MULTISAFEPAY_ALIPAY_MIN_AMOUNT')
            );
            Configuration::updateValue(
                'MULTISAFEPAY_ALIPAY_MAX_AMOUNT',
                Tools::getValue('MULTISAFEPAY_ALIPAY_MAX_AMOUNT')
            );
    ...
    public function renderForm()
    {
        ...
        $fields_form[0]['form'] = [
            ...
            'input' => [
                [
                    ...
                    'name' => 'MULTISAFEPAY_ALIPAY_MIN_AMOUNT',
                    'required' => false,
                ],
                [
                    'type' => 'text',
                    'class' => 'fixed-width-sm',
                    'prefix' => $this->context->currency->sign,
                    'label' => $this->l('Maximum order amount for Alipay'),
                    'name' => 'MULTISAFEPAY_ALIPAY_MAX_AMOUNT',
                    'required' => false,
                ],
            ],
            'submit' => [
        ...
        $helper->fields_value['MULTISAFEPAY_ALIPAY_MIN_AMOUNT'] = Configuration::get('MULTISAFEPAY_ALIPAY_MIN_AMOUNT');
        $helper->fields_value['MULTISAFEPAY_ALIPAY_MAX_AMOUNT'] = Configuration::get('MULTISAFEPAY_ALIPAY_MAX_AMOUNT');
