...
class Multisafepaygezondheidsbon extends PaymentModule
{
    public function __construct()
    {
        ...
        $this->name = 'multisafepaygezondheidsbon';
        ...
        $this->displayName = $this->l('Gezondheidsbon');
    ...
    public function install()
    {
        ...
        Configuration::updateValue('MULTISAFEPAY_GEZONDHEIDSBON_API_KEY', '');
        Configuration::updateValue('MULTISAFEPAY_GEZONDHEIDSBON_SANDBOX', '');
    ...
    {
        Configuration::deleteByName('MULTISAFEPAY_GEZONDHEIDSBON_API_KEY');
        Configuration::deleteByName('MULTISAFEPAY_GEZONDHEIDSBON_SANDBOX');
    ...
    public function getContent()
    {
        if (Tools::isSubmit('submit' . $this->name)) {
            Configuration::updateValue('MULTISAFEPAY_GEZONDHEIDSBON_API_KEY', Tools::getValue('MULTISAFEPAY_GEZONDHEIDSBON_API_KEY'));
            Configuration::updateValue('MULTISAFEPAY_GEZONDHEIDSBON_SANDBOX', Tools::getValue('MULTISAFEPAY_GEZONDHEIDSBON_SANDBOX'));
        }

        $CheckConnection = new CheckConnection('', '');
        $check = $CheckConnection->checkConnection(Tools::getValue('MULTISAFEPAY_GEZONDHEIDSBON_API_KEY'),
                                                    Tools::getValue('MULTISAFEPAY_GEZONDHEIDSBON_SANDBOX'));
        ...
        $fields_form[0]['form'] = [
            ...
            'input' => [
                [
                    ...
                    'name' => 'MULTISAFEPAY_GEZONDHEIDSBON_API_KEY',
                    'size' => 20,
                    'required' => false,
             ...
             [
                    ...
                    'name' => 'MULTISAFEPAY_GEZONDHEIDSBON_SANDBOX',
                    'class' => 't',
                    'is_bool' => true,
                    'required' => false,
        ...
        $helper->fields_value['MULTISAFEPAY_GEZONDHEIDSBON_API_KEY'] = Configuration::get('MULTISAFEPAY_GEZONDHEIDSBON_API_KEY');
        $helper->fields_value['MULTISAFEPAY_GEZONDHEIDSBON_SANDBOX'] = Configuration::get('MULTISAFEPAY_GEZONDHEIDSBON_SANDBOX');
