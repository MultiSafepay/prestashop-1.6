...
class Multisafepaynationaletuinbon extends PaymentModule
{
    public function __construct()
    {
        ...
        $this->name = 'multisafepaynationaletuinbon';
        ...
        $this->gateway = 'NATIONALETUINBON';
        $this->displayName = $this->l('Nationale Tuinbon');
    ...
    public function install()
    {
        ...
        Configuration::updateValue('MULTISAFEPAY_NATIONALETUINBON_API_KEY', '');
        Configuration::updateValue('MULTISAFEPAY_NATIONALETUINBON_SANDBOX', '');
    ...
    {
        Configuration::deleteByName('MULTISAFEPAY_NATIONALETUINBON_API_KEY');
        Configuration::deleteByName('MULTISAFEPAY_NATIONALETUINBON_SANDBOX');
    ...
    public function getContent()
    {
        if (Tools::isSubmit('submit' . $this->name)) {
            Configuration::updateValue('MULTISAFEPAY_NATIONALETUINBON_API_KEY', Tools::getValue('MULTISAFEPAY_NATIONALETUINBON_API_KEY'));
            Configuration::updateValue('MULTISAFEPAY_NATIONALETUINBON_SANDBOX', Tools::getValue('MULTISAFEPAY_NATIONALETUINBON_SANDBOX'));
        }

        $CheckConnection = new CheckConnection('', '');
        $check = $CheckConnection->checkConnection(Tools::getValue('MULTISAFEPAY_NATIONALETUINBON_API_KEY'),
                                                    Tools::getValue('MULTISAFEPAY_NATIONALETUINBON_SANDBOX'));
        ...
        $fields_form[0]['form'] = [
            ...
            'input' => [
                [
                    ...
                    'name' => 'MULTISAFEPAY_NATIONALETUINBON_API_KEY',
                    'size' => 20,
                    'required' => false,
                ...
                [
                    ...
                    'name' => 'MULTISAFEPAY_NATIONALETUINBON_SANDBOX',
                    'class' => 't',
                    'is_bool' => true,
                    'required' => false,
        ...
        $helper->fields_value['MULTISAFEPAY_NATIONALETUINBON_API_KEY'] = Configuration::get('MULTISAFEPAY_NATIONALETUINBON_API_KEY');
        $helper->fields_value['MULTISAFEPAY_NATIONALETUINBON_SANDBOX'] = Configuration::get('MULTISAFEPAY_NATIONALETUINBON_SANDBOX');
