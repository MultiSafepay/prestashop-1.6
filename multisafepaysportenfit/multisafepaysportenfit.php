...
class Multisafepaysportenfit extends PaymentModule
{
    public function __construct()
    {
        ...
        $this->gateway = 'SPORTENFIT';
        $this->displayName = $this->l('Sport en Fit Cadeau');
    ...
    public function install()
    {
        ...
        Configuration::updateValue('MULTISAFEPAY_SPORTENFIT_API_KEY', '');
        Configuration::updateValue('MULTISAFEPAY_SPORTENFIT_SANDBOX', '');
    ...
    {
        Configuration::deleteByName('MULTISAFEPAY_SPORTENFIT_API_KEY');
        Configuration::deleteByName('MULTISAFEPAY_SPORTENFIT_SANDBOX');
    ...
    public function getContent()
    {
        if (Tools::isSubmit('submit' . $this->name)) {
            Configuration::updateValue('MULTISAFEPAY_SPORTENFIT_API_KEY', Tools::getValue('MULTISAFEPAY_SPORTENFIT_API_KEY'));
            Configuration::updateValue('MULTISAFEPAY_SPORTENFIT_SANDBOX', Tools::getValue('MULTISAFEPAY_SPORTENFIT_SANDBOX'));
        }

        $CheckConnection = new CheckConnection('', '');
        $check = $CheckConnection->checkConnection(Tools::getValue('MULTISAFEPAY_SPORTENFIT_API_KEY'),
                                                    Tools::getValue('MULTISAFEPAY_SPORTENFIT_SANDBOX'));
        ...
        $fields_form[0]['form'] = [
            ...
            'input' => [
                [
                    ...
                    'name' => 'MULTISAFEPAY_SPORTENFIT_API_KEY',
                    'size' => 20,
                    'required' => false,
                ...
                [
                    ...
                    'name' => 'MULTISAFEPAY_SPORTENFIT_SANDBOX',
                    'class' => 't',
                    'is_bool' => true,
                    'required' => false,
        ...
        $helper->fields_value['MULTISAFEPAY_SPORTENFIT_API_KEY'] = Configuration::get('MULTISAFEPAY_SPORTENFIT_API_KEY');
        $helper->fields_value['MULTISAFEPAY_SPORTENFIT_SANDBOX'] = Configuration::get('MULTISAFEPAY_SPORTENFIT_SANDBOX');
